...
import com.libraryadminbackend.model.dto.user.UserQueryRequest;
import com.libraryadminbackend.model.entity.User;
import com.libraryadminbackend.model.enums.UserRoleEnum;
import com.libraryadminbackend.model.vo.LoginUserVO;
import com.libraryadminbackend.model.vo.UserVO;
...
import static com.libraryadminbackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "wujian";

    @Override
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        // 1. 校验
        if (StrUtil.isAllEmpty(userAccount, userPassword, checkPassword)) {
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        // 1. 校验
        if (StrUtil.isAllEmpty(userAccount, userPassword)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "参数为空");
        }
        if (userAccount.length() < 4) {
